# Migration `20190812150328-init`

This migration has been generated by Jaco Basson at 8/12/2019, 3:03:28 PM.
...
CREATE TABLE "fullstack"."Restaurant"("id" text NOT NULL  ,"createdAt" timestamp(3) NOT NULL  ,"name" text NOT NULL DEFAULT '' ,"pictureURL" text NOT NULL DEFAULT '' ,"location" text NOT NULL DEFAULT '' ,PRIMARY KEY ("id"));
...
ALTER TABLE "fullstack"."Restaurant" ADD COLUMN "author" text   REFERENCES "fullstack"."User"("id");
...
You can use a specific Photon built for this migration (20190812150328-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190812150328-init'
